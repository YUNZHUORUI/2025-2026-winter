...
\begin{itemize}[noitemsep]
    ...
    \item Phase~3 CFD confirming a full-vehicle cruise $L/D = 4.8$ (Table~\ref{tab:cfd}), consistent with the Chapter~\ref{ch:simulation} ANSYS Fluent result and used as the basis for the range and energy estimates under the selected MH114 airfoil.
