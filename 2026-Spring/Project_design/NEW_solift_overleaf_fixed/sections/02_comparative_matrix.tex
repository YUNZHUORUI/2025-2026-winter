...
\label{tab:weights}
\begin{tabularx}{\textwidth}{C{0.5cm} L{4.5cm} C{2cm} X}
\toprule
...
\begin{tabularx}{\textwidth}{X C{1.8cm} C{1.8cm} C{1.8cm} C{1.8cm} C{1.8cm}}
\toprule
...
\begin{figure}[htbp]
    \centering
    \includegraphics[angle=180, width=0.82\textwidth]{figures/Solift_schematic.jpg}
...
\begin{tabularx}{\textwidth}{C{1cm} L{3.8cm} C{2cm} C{1.8cm} X}
\toprule
